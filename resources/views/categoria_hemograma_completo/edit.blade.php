<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900">Editar Categoría de Hemograma Completo</h2>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto mt-8 bg-white rounded-2xl shadow-lg border border-gray-100 p-10">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-extrabold text-indigo-700">Editar Categoría de Hemograma Completo</h1>
            <p class="text-gray-500 text-sm mt-2">Modifica el nombre de la categoría y guarda los cambios.</p>
        </div>

        <form action="{{ route('categoria_hemograma_completo.update', $categoriaHemogramaCompleto) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $categoriaHemogramaCompleto->nombre) }}"
