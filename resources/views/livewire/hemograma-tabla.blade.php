                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text"
                                    wire:model.live="search"  name="search" placeholder="Buscar hemograma..." 
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b ">
                            ...
                            <td class="px-4 py-3">{{ $h->nombre }}</td>
                            <td class="px-4 py-3">{{ $h->categoria->nombre  }}</td>
                            <td class="px-4 py-3">{{ $h->unidad->nombre  }}</td>
                            <td class="px-4 py-3">{{ $h->referencia  }}</td>
                            <td class="px-4 py-3">
