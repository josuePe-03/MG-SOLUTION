                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text"
                                    wire:model.live="search"  name="search" placeholder="Buscar perfiles..." 
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b ">
                            <td class="px-4 py-3">{{ $perfil->id }}</td>
                            <td class="px-4 py-3">{{ $perfil->nombre }}</td>
                            <td class="px-4 py-3">
                                ...
                                <form action="{{ route('perfiles.destroy', $perfil) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="submit"
