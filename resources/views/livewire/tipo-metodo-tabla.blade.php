                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text"
                                    wire:model.live="search"  name="search" placeholder="Buscar tipo metodo..." 
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b ">
                            <td class="px-4 py-3">{{ $metodo->id }}</td>
                            <td class="px-4 py-3">{{ $metodo->nombre }}</td>
                            <td class="px-4 py-3">
                                <a href="{{ route('tipo_metodo.edit', $metodo) }}" 
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-3 text-center text-gray-500">
                                No se encontraron tipos de metodos.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
