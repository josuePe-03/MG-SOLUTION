            ...
            <div class="bg-whiterelative shadow-lg sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text"
                                    wire:model.live="search"  name="search" placeholder="Buscar categorias..." 
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <a 
                        href="{{ route('categorias-productos.create') }}"
                    ...
                    <tbody>
                        ...
                        <tr class="border-b ">
                            ...
                            <td class="px-4 py-3">
                                ...
                                <form action="{{ route('categorias-productos.destroy', $categoria) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="submit"
