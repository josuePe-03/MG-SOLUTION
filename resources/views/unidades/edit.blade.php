<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-semibold text-gray-800">Editar Unidad</h2>
    </x-slot>
    ...
    <div class="max-w-xl mx-auto mt-6 bg-white rounded-lg shadow p-6">
        <form action="{{ route('unidades.update', $unidad) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nombre" name="nombre" value="{{ $unidad->nombre }}" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-indigo-400" required>
            </div>
