<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-semibold text-gray-800">Nueva Marca</h2>
    </x-slot>

    <form action="{{ route('marcas-productos.store') }}" method="POST" class="max-w-lg mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mt-6">
        @csrf

        <!-- Header interno -->
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-extrabold text-indigo-700">Crear Nueva Marca</h1>
            <p class="text-gray-500 text-sm mt-2">Ingresa los datos de la marca y guarda para continuar.</p>
        </div>
