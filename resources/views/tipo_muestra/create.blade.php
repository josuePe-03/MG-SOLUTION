<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900">Crear Tipo de Muestra</h2>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto mt-8 bg-white rounded-2xl shadow-lg border border-gray-100 p-10">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-extrabold text-indigo-700">Registrar Tipo de Muestra</h1>
            <p class="text-gray-500 text-sm mt-2">Completa el nombre del tipo de muestra y guarda los cambios.</p>
        </div>

        <form action="{{ route('tipo_muestra.store') }}" method="POST" class="space-y-6">
            @csrf
