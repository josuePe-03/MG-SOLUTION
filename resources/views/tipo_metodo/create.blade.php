<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900">Crear Método</h2>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto mt-8 bg-white rounded-2xl shadow-lg border border-gray-100 p-10">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-extrabold text-indigo-700">Registrar un Nuevo Método</h1>
            <p class="text-gray-500 text-sm mt-2">Completa el siguiente formulario para agregar un método al sistema.</p>
        </div>

        <form action="{{ route('tipo_metodo.store') }}" method="POST" class="space-y-6">
            @csrf
